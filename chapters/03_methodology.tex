...
\textbf{Synergi med OCR-output:} Claude håndterer effektivt den ukomplette og støjede tekst, som OCR-processen typisk producerer fra industrielle labels som f.eks. forkortelser, enheder og tekst med OCR-artefakter. Denne egenskab reducerer antallet af fejlklassificerede entiteter sammenlignet med modeller, der forventer velformateret inputtekst.
